...
cms(){
  bash <(curl -s https://raw.githubusercontent.com/Kyzegs/habbo-retro-script/master/script/cms-install.sh)
}

nitro(){
  bash <(curl -s https://raw.githubusercontent.com/Kyzegs/habbo-retro-script/master/script/nitro-install.sh)
}

emulator(){
  bash <(curl -s https://raw.githubusercontent.com/Kyzegs/habbo-retro-script/master/script/emulator-install.sh)
}
